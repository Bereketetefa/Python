...
#     return render_template("ninjagold.html", num=int(number), change=color)
...
def index():
	...
	return render_template('ninjagold.html', count=session['count'], message=session['message'])
